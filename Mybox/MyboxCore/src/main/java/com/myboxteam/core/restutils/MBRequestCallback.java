...
public class MBRequestCallback implements RequestCallback {
	
	private List<HttpMessageConverter<?>> messageConverters = new ArrayList<HttpMessageConverter<?>>();
	private Map<String, String> headerAttrs;
	private Object requestBody;
	
	public MBRequestCallback() { }
	
	public MBRequestCallback(Map<String, String> headerAttrs) {
		this.headerAttrs = headerAttrs;
		this.requestBody = null;
	}
	
	public MBRequestCallback(Map<String, String> headerAttrs, Object requestBody, 
