...
public class MBBaseDao extends SqlSessionDaoSupport{
	
	private static final Logger logger = LogManager.getLogger(MBBaseDao.class);
	
	protected String mNamespace;

	protected MBBaseDao(String namespace) {
	...
	public int insert(String name, MBBaseModel prm) throws SQLException {
		return getSqlSession().insert(mNamespace + "." + name, prm);
	}
	public <E> List<E> selectList(String name, MBBaseModel prm)
			throws SQLException {
	...
	public Object selectOne(String name, MBBaseModel parameter)
			throws SQLException {
	...
	public int update(String name, MBBaseModel parameter) throws SQLException {
		return getSqlSession().update(mNamespace + "." + name, parameter);
	}
	
	public int delete(String name, MBBaseModel parameter) throws SQLException {
