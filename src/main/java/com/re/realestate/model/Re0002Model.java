package com.re.realestate.model;

import java.util.Date;

import com.re.realestate.utils.ReUtils;

public class Re0002Model extends ReBaseModel {
	...
	public String getTrading_date_label() {
		return ReUtils.convertDateToStrSlashDDMMYYY(trading_date);
	}
