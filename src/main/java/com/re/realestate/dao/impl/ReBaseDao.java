...
import com.re.realestate.model.ReBaseModel;

public class ReBaseDao extends SqlSessionDaoSupport{
	
	private static final Logger logger = LogManager.getLogger(ReBaseDao.class);
	
	protected String mNamespace;

	protected ReBaseDao(String namespace) {
	...
	public int insert(String name, ReBaseModel prm) throws SQLException {
		return getSqlSession().insert(mNamespace + "." + name, prm);
	}
	public <E> List<E> selectList(String name, ReBaseModel prm)
			throws SQLException {
	...
	public Object selectOne(String name, ReBaseModel parameter)
			throws SQLException {
	...
	public int update(String name, ReBaseModel parameter) throws SQLException {
		return getSqlSession().update(mNamespace + "." + name, parameter);
	}
	
	public int delete(String name, ReBaseModel parameter) throws SQLException {
